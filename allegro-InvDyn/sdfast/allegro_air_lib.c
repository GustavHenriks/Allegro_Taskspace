...
} allegro_air_gerror_t;
#define lasterr (allegro_air_gerror.lasterr_)
#define lastrou (allegro_air_gerror.lastrou_)

allegro_air_gerror_t allegro_air_gerror = {
/* Error parameters
*/
    /* lasterr */ 0,
    /* lastrou */ 0,
...
void allegro_air_prerrmsg(FILE *fnum,
    int routine,
    int errnum)
{
    ...
    fprintf(fnum,"\n");
    if (routine == 1) {
        fprintf(fnum,"allegro_air_grav:\n");
    }
    if (routine == 2) {
        fprintf(fnum,"allegro_air_mass:\n");
    }
    if (routine == 3) {
        fprintf(fnum,"allegro_air_iner:\n");
    }
    if (routine == 4) {
        fprintf(fnum,"allegro_air_btj:\n");
    }
    if (routine == 5) {
        fprintf(fnum,"allegro_air_itj:\n");
    }
    if (routine == 6) {
        fprintf(fnum,"allegro_air_pin:\n");
    }
    if (routine == 7) {
        fprintf(fnum,"allegro_air_init:\n");
    }
    if (routine == 8) {
        fprintf(fnum,"allegro_air_state:\n");
    }
    if (routine == 9) {
        fprintf(fnum,"allegro_air_psstate:\n");
    }
    if (routine == 13) {
        fprintf(fnum,"allegro_air_presacc:\n");
    }
    if (routine == 14) {
        fprintf(fnum,"allegro_air_presvel:\n");
    }
    if (routine == 15) {
        fprintf(fnum,"allegro_air_prespos:\n");
    }
    if (routine == 10) {
        fprintf(fnum,"allegro_air_hinget:\n");
    }
    if (routine == 11) {
        fprintf(fnum,"allegro_air_pointf:\n");
    }
    if (routine == 12) {
        fprintf(fnum,"allegro_air_bodyt:\n");
    }
    if (routine == 17) {
        fprintf(fnum,"allegro_air_deriv:\n");
    }
    if (routine == 16) {
        fprintf(fnum,"allegro_air_resid:\n");
    }
    if (routine == 18) {
        fprintf(fnum,"allegro_air_pseudo:\n");
    }
    if (routine == 19) {
        fprintf(fnum,"allegro_air_mom:\n");
    }
    if (routine == 20) {
        fprintf(fnum,"allegro_air_sys:\n");
    }
    if (routine == 21) {
        fprintf(fnum,"allegro_air_pos:\n");
    }
    if (routine == 22) {
        fprintf(fnum,"allegro_air_vel:\n");
    }
    if (routine == 23) {
        fprintf(fnum,"allegro_air_orient:\n");
    }
    if (routine == 24) {
        fprintf(fnum,"allegro_air_angvel:\n");
    }
    if (routine == 25) {
        fprintf(fnum,"allegro_air_trans:\n");
    }
    if (routine == 26) {
        fprintf(fnum,"allegro_air_perr:\n");
    }
    if (routine == 27) {
        fprintf(fnum,"allegro_air_verr:\n");
    }
    if (routine == 28) {
        fprintf(fnum,"allegro_air_psqdot:\n");
    }
    if (routine == 29) {
        fprintf(fnum,"allegro_air_psudot:\n");
    }
    if (routine == 30) {
        fprintf(fnum,"allegro_air_getht:\n");
    }
    if (routine == 31) {
        fprintf(fnum,"allegro_air_reac:\n");
    }
    if (routine == 32) {
        fprintf(fnum,"allegro_air_acc:\n");
    }
    if (routine == 33) {
        fprintf(fnum,"allegro_air_angacc:\n");
    }
    if (routine == 34) {
        fprintf(fnum,"allegro_air_mult:\n");
    }
    if (routine == 35) {
        fprintf(fnum,"allegro_air_aerr:\n");
    }
    if (routine == 36) {
        fprintf(fnum,"allegro_air_indx:\n");
    }
    if (routine == 37) {
        fprintf(fnum,"allegro_air_pres:\n");
    }
    if (routine == 38) {
        fprintf(fnum,"allegro_air_stab:\n");
    }
    if (routine == 39) {
        fprintf(fnum,"allegro_air_getgrav:\n");
    }
    if (routine == 40) {
        fprintf(fnum,"allegro_air_getmass:\n");
    }
    if (routine == 41) {
        fprintf(fnum,"allegro_air_getiner:\n");
    }
    if (routine == 42) {
        fprintf(fnum,"allegro_air_getbtj:\n");
    }
    if (routine == 43) {
        fprintf(fnum,"allegro_air_getitj:\n");
    }
    if (routine == 44) {
        fprintf(fnum,"allegro_air_getpin:\n");
    }
    if (routine == 45) {
        fprintf(fnum,"allegro_air_getpres:\n");
    }
    if (routine == 46) {
        fprintf(fnum,"allegro_air_getstab:\n");
    }
    if (routine == 47) {
        fprintf(fnum,"allegro_air_info:\n");
    }
    if (routine == 48) {
        fprintf(fnum,"allegro_air_jnt:\n");
    }
    if (routine == 49) {
        fprintf(fnum,"allegro_air_cons:\n");
    }
    if (routine == 50) {
        fprintf(fnum,"allegro_air_assemble:\n");
    }
    if (routine == 51) {
        fprintf(fnum,"allegro_air_initvel:\n");
    }
    if (routine == 52) {
        fprintf(fnum,"allegro_air_static:\n");
    }
    if (routine == 53) {
        fprintf(fnum,"allegro_air_steady:\n");
    }
    if (routine == 54) {
        fprintf(fnum,"allegro_air_motion:\n");
    }
    if (routine == 55) {
        fprintf(fnum,"allegro_air_fmotion:\n");
    }
    if (routine == 56) {
        fprintf(fnum,"allegro_air_equivht:\n");
    }
    if (routine == 57) {
        fprintf(fnum,"allegro_air_massmat:\n");
    }
    if (routine == 58) {
        fprintf(fnum,"allegro_air_frcmat:\n");
    }
    if (routine == 59) {
        fprintf(fnum,"allegro_air_rel2cart:\n");
    }
    if (routine == 60) {
        fprintf(fnum,"allegro_air_comptrq:\n");
    }
    if (routine == 61) {
        fprintf(fnum,"allegro_air_fulltrq:\n");
    }
    if (routine == 62) {
        fprintf(fnum,"allegro_air_vrot:\n");
    }
    if (errnum == 1) {
    ...
    if (errnum == 22) {
        fprintf(fnum,"allegro_air_init must be called first\n");
    }
    if (errnum == 23) {
        fprintf(fnum,"allegro_air_state must be called first\n");
    }
    if (errnum == 24) {
        fprintf(fnum,"allegro_air_deriv must be called first\n");
    }
    if (errnum == 25) {
...
void allegro_air_error(int *routine,
    int *errnum)
{
...
void allegro_air_printerr(FILE *fnum)
{

    allegro_air_prerrmsg(fnum,lastrou,lasterr);
}

void allegro_air_clearerr(void)
{
...
void allegro_air_seterr(int routine,
    int errnum)
{
...
void allegro_air_ldudcomp(int n,
    int na,
    int map[],
    double tol,
    double ld[],
...
void allegro_air_ldubslv(int n,
    int na,
    int map[],
    double work[],
    double l[],
    ...
    double x[])
{
    ...
    allegro_air_ldubsl(n,na,map,l,b,work);
    allegro_air_ldubsd(n,na,map,d,work,work);
    allegro_air_ldubsu(n,na,map,l,work,x);
}

void allegro_air_lduslv(int n,
    int na,
    int map[],
    double tol,
    double work1[],
    ...
    double x[])
{
    ...
    allegro_air_ldudcomp(n,na,map,tol,work1,work2,m,l,d);
    allegro_air_ldubslv(n,na,map,work2,l,d,b,x);
}
...
void allegro_air_qrdcomp(int nr,
    int nc,
    int nra,
    int nca,
    int mapr[],
...
void allegro_air_qrbslv(int nr,
    int nc,
    int nra,
    int nca,
    int mapr[],
    ...
    int *rank)
{
    ...
    if (k  !=  0) {
        allegro_air_qrsl(nr,nc,nra,nca,mapr,mapc,k,work,w,qraux,b,x);
    }
    for (j = k; j <= nca-1; j++) {
        x[mapc[j]] = 0.;
    }
    ...
    int *rank)
{
    ...
    allegro_air_qrdcomp(nr,nc,nra,nca,mapr,mapc,w,qraux,jpvt);
    allegro_air_qrbslv(nr,nc,nra,nca,mapr,mapc,tol,work,iwork,w,qraux,
      jpvt,b,x,rank);
}
    ...
    double x[])
{
    ...
    if (ndes  ==  0) {
        ...
        allegro_air_qrslv(nra,nra,nra,nra,&iw[map],&iw[map],tol,&iw[jpvt],&rw[
        ...
        allegro_air_qrslv(dsiz,dsiz,dsiz,dsiz,&iw[map],&iw[map],tol,&iw[jpvt],&
...
/* Utility routines for use with allegro_air_root. */


void allegro_air_calcerrs(double fval[],
    int nfunc,
    int ndes,
    int dnorm,
    double *maxderr,
...
void allegro_air_adjvars(int (*func)(),
    double vars[],
    double param[],
    int nfunc,
    int ndes,
    ...
    double newerrs[])
{
    ...
    *fcnt = *fcnt+1;
    ...
    allegro_air_calcerrs(newerrs,nfunc,ndes,dnorm,&maxderr,&maxrerr,&derrnorm);
...
void allegro_air_calcjac(int (*func)(),
    double vars[],
    double param[],
    int nfunc,
    int nvar,
...
void allegro_air_root(int (*func)(),
    double vars[],
    double param[],
    int nfunc,
    int nvar,
    ...
    int *err)
{
    ...
    *fcnt = *fcnt+1;
    allegro_air_calcerrs(fret,nfunc,ndes,dnorm,&pmaxderr,&pmaxrerr,&pderrnorm);
    crude = 1e-6;
    for (ntrys = 0; ntrys < 2; ntrys++) {
        ...
        for (;;) {
            ...
            allegro_air_calcjac(func,vars,param,nfunc,nvar,lock,crude,fret,&rw[
              f1],jw,fcnt,&rw[scale]);
            for (i = 0; i < nfunc; i++) {
                rw[f1+i] = fret[i]*rw[scale+i];
            }
            allegro_air_lsslv(nfunc,nvar,nfunc,nvar,ndes,&iw[mapf],&iw[mapv]
              ,qrtol,dw,&rw[morerw],&iw[moreiw],jw,&rw[f1],&rw[deltav]);
            for (;;) {
                allegro_air_adjvars(func,vars,param,nfunc,ndes,dnorm,nvar,&rw[
                  deltav],step,pmaxrerr,pderrnorm,rtol,fcnt,&rw[guess],&rw[f1]);
                allegro_air_calcerrs(&rw[f1],nfunc,ndes,dnorm,&maxderr,&maxrerr,
                  &derrnorm);
...
/* Utility routine for use with allegro_air_finteg and allegro_air_vinteg.  Work is 2*neq. */


void allegro_air_rk4m(int (*func)(),
    double time,
    double st[],
    double dst0[],
    double param[],
...
void allegro_air_finteg(int (*func)(),
    double *time,
    double st[],
    double dst[],
    double param[],
    ...
    int *status)
{
    ...
    ttime = *time;
    if (step > 0.) {
        allegro_air_rk4m(func,ttime,st,dst,param,step,&work[nst],neq,&work[
...
void allegro_air_vinteg(int (*func)(),
    double *time,
    double st[],
    double dst[],
    double param[],
    ...
    int *which)
{
    ...
    *err = 0;
    ...
    while (ttime  <  tfin) {
        ...
        nstp = stp;
        for (;;) {
            allegro_air_rk4m(func,ttime,st,dst,param,nstp,&work[xst],neq,&work[
            ...
            if (stp2 < minstep) {
                ...
                allegro_air_rk4m(func,xtime,&work[xst],&work[xdst],param,stp2,&
...
void allegro_air_dc2ang(double dircos[3][3],
    double *a1,
    double *a2,
    double *a3)
{
...
void allegro_air_dc2quat(double dircos[3][3],
    double *e1,
    double *e2,
    double *e3,
    double *e4)
...
void allegro_air_ang2dc(double a1,
    double a2,
    double a3,
    double dircos[3][3])
{
...
void allegro_air_quat2dc(double ie1,
    double ie2,
    double ie3,
    double ie4,
    double dircos[3][3])
...
double 
allegro_air_vdot(double ivec1[3],
    double ivec2[3])
{
    double dprod;
...
double 
allegro_air_vnorm(double ivec[3])
{
    double norm;

/* Compute the length (norm) of a vector
*/
    norm = sqrt(allegro_air_vdot(ivec,ivec));
    return norm;
}

void allegro_air_vcopy(double ivec[3],
    double ovec[3])
{
...
void allegro_air_vset(double sclr1,
    double sclr2,
    double sclr3,
    double ovec[3])
{
...
void allegro_air_vadd(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void allegro_air_vsub(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void allegro_air_vmul(double sclr,
    double ivec[3],
    double ovec[3])
{
...
void allegro_air_vaxpy(double sclr,
    double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void allegro_air_vcross(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
    double tempout[3];
...
void allegro_air_vrot(double ivec[3],
    double rvec[3],
    double theta,
    double ovec[3])
{
...
*/
    norm = allegro_air_vnorm(rvec);
    if (norm == 0.) {
        ovec[0] = ivec[0];
        ovec[1] = ivec[1];
        ovec[2] = ivec[2];
        allegro_air_seterr(62,46);
        return;
    }
    stheta = sin(theta);
    ctheta = cos(theta);
    allegro_air_vmul(stheta,ivec,isinvec);
    allegro_air_vmul(ctheta,ivec,icosvec);
    norm = 1./norm;
    allegro_air_vmul(norm,rvec,uvec);
    idotu = allegro_air_vdot(ivec,uvec);
    allegro_air_vcross(uvec,isinvec,uxisin);
    dotcos = idotu*(1.-ctheta);
    allegro_air_vaxpy(dotcos,uvec,icosvec,ovec);
    allegro_air_vadd(ovec,uxisin,ovec);
}

void allegro_air_serialno(int *serno)
{
