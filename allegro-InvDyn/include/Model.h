...
extern "C"
{
    ...
    void allegro_air_reac(double force[AIR_N_U][3],
              double torque[AIR_N_U][3]);

    /************************************************************************/

    void allegro_air_equivht(double tau[AIR_N_U]);

    void allegro_air_comptrq(double udotin[AIR_N_U],
                         double trqout[AIR_N_U]);

    void allegro_air_fulltrq(double udotin[AIR_N_U],
                         double multin[AIR_N_U],
                         double trqout[AIR_N_U]);

    void allegro_air_massmat(double mmat[AIR_N_U][AIR_N_U]);

    void allegro_air_frcmat(double fmat[AIR_N_U]);

    void allegro_air_multtrq(double multin[AIR_N_U],
                         double trqout[AIR_N_U]);
    ...
    void allegro_air_reac(double force[39][3],
                        double torque[39][3]);
    ...
    void allegro_air_deriv(double oqdot[AIR_N_U+1],
                        double oudot[AIR_N_U]);

    void allegro_air_getmass(int body,
                        double *massout);

    void allegro_air_mult(double omults[AIR_N_U],
                    int *owrank,
                    int omultmap[AIR_N_U]);

    void allegro_air_setudot(double iudot[AIR_N_U]);

    void allegro_air_qdot(double oqdot[AIR_N_U+1]);
